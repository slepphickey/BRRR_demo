...
# these are from https://soundbible.com
# cat's meow
skrrrahh("wav_files/Cat_Meow.wav")
```

```{r}
# example for announcing the completion of your function
...
slow_function = function(x){
  ...
  # progress bar to show that the function is woeking even though it's slow
